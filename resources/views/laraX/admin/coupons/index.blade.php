    ...
    <script>
        $(document).ready(function(){
            TableDatatablesAjax.init({
                ajaxGet: '{{ asset($adminPath.'/coupons') }}',
                src: $('#datatable_ajax'),
                ...
                editableFields: [2],
                actionPosition: 7,
                ajaxUrlSaveRow: '{{ asset($adminPath.'/coupons/fast-edit') }}'
            });
        });
    </script>
@endsection
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">All coupons</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm active" href="{{ asset($adminPath.'/coupons/edit/0/') }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable vertical-middle" id="datatable_ajax">
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    <input placeholder="Search..." type="text" class="form-control form-filter input-sm" name="coupon_code">
                                </td>
                                <td>
