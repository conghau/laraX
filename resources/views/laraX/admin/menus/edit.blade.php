...
@section('content')
    <form action="" accept-charset="utf-8" method="POST"
          class="js-validate-form form-save-menu clearfix">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="note note-danger">
                    <p><label class="label label-danger">NOTE</label> You need
                        to enable javascript.</p>
                </div>
                <div class="note note-danger">
                    <p><label class="label label-danger">NOTE</label> <b>Edit
                            menu structure</b> is supported in
                        Firefox, Chrome, Opera, Safari, Internet Explorer 10 and
                        Internet Explorer 9 only. Internet
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="language_id"
                                ...
                                {{--@if(!laraX_isNullOrEmpty($activatedLanguages))--}}
    ...
    @if(!laraX_isNullOrEmpty($object) && $object->id)
        <div class="row">
            <div class="col-md-4">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                            ...
                            <div id="external_link" class="the-box">
                                <div class="form-group">
                                    ...
                                    <input type="text" required=""
                                           class="form-control" id="node-title"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required=""
                                           class="form-control" id="node-url"
                                           placeholder="http://" value=""
                                           name="" autocomplete="false">
                                </div>
                                <div class="form-group">
                                    <label for="node-css" class="">CSS
                                        class</label>
                                    <input type="text" required=""
                                           class="form-control" id="node-css"
                                           placeholder="" value="" name=""
                                           autocomplete="false">
                                </div>
                                <div class="text-right">
                                    <div class="btn-group btn-group-devided">
                                        <a href="#" title=""
                                           class="btn-add-to-menu btn btn-success btn-sm btn-circle btn-transparent active"><span
                                                    class="text"><i
                                                        class="fa fa-plus"></i> Add to menu</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @foreach ($pages as $key => $row)
                                            <li>
                                                <a href="#" data-type="page"
                                                   ...
                                                   data-title="{{ $row->global_title }}">{{ $row->global_title }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                    <div class="text-right">
