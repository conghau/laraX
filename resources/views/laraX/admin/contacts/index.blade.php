            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">All contacts</span>
                    </div>
                </div>
                    ...
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <select class="table-group-action-input form-control input-inline input-small input-sm">
                                ...
                                <option value="1">Set as viewed</option>
                                <option value="0">Set as new</option>
                            </select>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable vertical-middle" id="datatable_ajax">
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td></td>
                                <td>
                                    <input placeholder="Search..." type="text" class="form-control form-filter input-sm" name="subject">
                                </td>
                                <td>
